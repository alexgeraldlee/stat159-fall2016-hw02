...
```{r, echo=T}
print('Table 1: Information about Regression Coefficients')
ad_summ$coefficients

print(paste0('Correlation coefficient: ', ad_summ$r.squared))
```

The estimates of these coefficients, a and b, are 7.033 and .048, respectively; that is, for every $1,000 increase in spending on TV advertising, sales are projected to increase by 48 units. With an R^2^ of .612, that means 61.2% of the variability is explained by the model. 

![Scatterplot of TV vs Sales](../images/scatterplot-tv-sales.png "Positive Correlation between TV budget and Sales")


#Conclusions
There is a positive correlation between the budget for TV advertising and Sales; however, this relationship is very minimal. For every $1,000 spent on advertising only another 48 units are sold, so each unit would have to cost at least $20.84 in order to make a profit off the units sold. 